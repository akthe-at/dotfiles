-- My own version of Muted Forest Night.
...
vim.g.colors_name = 'muted-forest-night' -- Renamed to reflect the new palette

-- Muted Forest Night Palette Mapping
-- Base16-inspired colors for a comprehensive dark theme with earthy, calm tones.
local colors = {
    -- Core Colors (Shades of Gray/Earthy Tones)
    bg = '#2B2D2F',             -- base00: Background (dark charcoal gray)
    black = '#2B2D2F',          -- base00: Darkest element, fitting for 'black'
    menu = '#3A3C3F',           -- base01: Lighter Background / Secondary BG (for pop-up menus, etc.)
    transparent_black = '#3A3C3F', -- base01: For overlays like statusline background
    transparent_blue = '#3A3C3F', -- base01: For transparent overlays
    transparent_green = '#3A3C3F', -- base01: For transparent overlays
    transparent_red = '#3A3C3F', -- base01: For transparent overlays
    transparent_yellow = '#3A3C3F', -- base01: For transparent overlays
    selection = '#4D5053',      -- base02: Mid-Background / UI Elements / Selection
    visual = '#4D5053',         -- base02: Same as selection
    comment = '#6B706E',        -- base03: Subtle UI / Comments (medium-dark gray)
    lilac = '#6B706E',          -- base03: Subtle UI, good for line numbers, nontext (using base03 for this role)
    nontext = '#6B706E',        -- base03: Subtle UI
    grey = '#9CA19D',           -- base04: Faded Foreground / Inactive Text (muted light gray)
    fg = '#DCE2DD',             -- base05: Default Foreground / Main Text (soft, parchment-like off-white)
    white = '#DCE2DD',          -- base05: Same as main foreground
    bright_white = '#FFFFFF',   -- base07: Very Bright / Emphatic UI (pure white)

    -- Accent Colors (Syntax & Semantic Meanings)
    red = '#C87A7A',            -- base08: Red / Error / Removed (muted, earthy red)
    bright_red = '#C87A7A',     -- base08: Consistent with main red
    orange = '#F2C94C',         -- base09: Orange / Warning / Numbers (warm, desaturated gold/yellow)
    yellow = '#F2C94C',         -- base09: Using base09 for main yellow/orange
    bright_yellow = '#D0D978',  -- base0A: Yellow / Other Warnings / Annotations (soft, muted green-yellow)
    green = '#9ECA9A',          -- base0B: Green / Success / Added (muted, soft green)
    bright_green = '#9ECA9A',   -- base0B: Consistent with main green
    cyan = '#7CC2B8',           -- base0C: Aqua / Info / Specific Elements (calm, muted aqua)
    bright_cyan = '#7CC2B8',    -- base0C: Consistent with main cyan
    bright_blue = '#7A9AD2',    -- base0D: Blue / Functions / Imports (muted, slightly desaturated blue)
    purple = '#BF9AA3',         -- base0E: Purple / Keywords / Preprocessor (soft, dusty rose/lavender)
    lavender = '#BF9AA3',       -- base0E: Consistent with purple tones
    bright_magenta = '#BF9AA3', -- base0E: Consistent with purple tones
    -- Custom vibrant colors adjusted for the palette's feel
    fuchsia = '#C47C9E',        -- A deeper, more muted berry/pink
    pink = '#BF9AA3',           -- Using base0E, the dusty rose
    neon_cyan = '#7CC2B8',      -- Using base0C, the calm aqua
}
