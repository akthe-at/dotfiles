-- My own version of Deep Ocean Clarity - Enhanced Contrast (with original Purple).
...
vim.g.colors_name = 'deep-ocean-clarity-contrast-v2' -- Renamed to reflect the updated palette

-- Deep Ocean Clarity - Enhanced Contrast Palette Mapping
-- Base16-inspired colors for a comprehensive dark theme with clear, distinct accents,
-- retaining the original muted purple/lavender.
local colors = {
    -- Core Colors (Shades of Dark Blue/Purple-Gray)
    bg = '#1E2833',             -- base00: Background (very dark, subtle blue-gray)
    black = '#1E2833',          -- base00: Darkest element, fitting for 'black'
    menu = '#2A3B49',           -- base01: Lighter Background / Secondary BG (for pop-up menus, etc.)
    transparent_black = '#2A3B49', -- base01: For overlays like statusline background
    transparent_blue = '#2A3B49', -- base01: For transparent overlays
    transparent_green = '#2A3B49', -- base01: For transparent overlays
    transparent_red = '#2A3B49', -- base01: For transparent overlays
    transparent_yellow = '#2A3B49', -- base01: For transparent overlays
    selection = '#3B5162',      -- base02: Mid-Background / UI Elements / Selection
    visual = '#3B5162',         -- base02: Same as selection
    comment = '#5E6D7E',        -- base03: Subtle UI / Comments (medium-dark, slightly blue-gray)
    lilac = '#5E6D7E',          -- base03: Subtle UI, good for line numbers, nontext (using base03 for this role)
    nontext = '#5E6D7E',        -- base03: Subtle UI
    grey = '#8C9DAE',           -- base04: Faded Foreground / Inactive Text (muted light gray-blue)
    fg = '#E0E6EB',             -- base05: Default Foreground / Main Text (soft, cool off-white)
    white = '#E0E6EB',          -- base05: Same as main foreground
    bright_white = '#FFFFFF',   -- base07: Very Bright / Emphatic UI (pure white)

    -- Accent Colors (Syntax & Semantic Meanings - Enhanced Contrast, with original purple)
    red = '#E66B6B',            -- base08: Red / Error / Removed (clear, distinct red)
    bright_red = '#E66B6B',     -- base08: Consistent with main red
    orange = '#FFC107',         -- base09: Orange / Warning / Numbers (bright, clear orange/gold)
    yellow = '#FFC107',         -- base09: Using base09 for main yellow/orange
    bright_yellow = '#FFD700',  -- base0A: Yellow / Other Warnings / Annotations (pure, bright yellow)
    green = '#4CAF50',          -- base0B: Green / Success / Added (standard, vibrant green)
    bright_green = '#4CAF50',   -- base0B: Consistent with main green
    cyan = '#00ACC1',           -- base0C: Aqua / Info / Specific Elements (clear, bright aqua/cyan)
    bright_cyan = '#00ACC1',    -- base0C: Consistent with main cyan
    bright_blue = '#42A5F5',    -- base0D: Blue / Functions / Imports (distinct, clear blue)
    purple = '#AB96BE',         -- base0E: Purple / Keywords / Preprocessor (ORIGINAL MUTED PURPLE)
    lavender = '#AB96BE',       -- base0E: Consistent with original muted purple tones
    bright_magenta = '#AB96BE', -- base0E: Consistent with original muted purple tones
    -- Custom vibrant colors adjusted for the palette's feel
    fuchsia = '#F06292',        -- A bright, clear pink for strong emphasis
    pink = '#F06292',           -- Same as fuchsia for consistency in the template
    neon_cyan = '#00E5FF',      -- A very bright, electric cyan for links/special
}
...
-- Mapped statusline mode colors to align with the new palette's accents
for mode, color_name in pairs {
    Normal = 'purple',
    Pending = 'pink',
    Visual = 'yellow',
    Insert = 'green',
    ...
    statusline_groups['StatuslineMode' .. mode] = { fg = colors.transparent_black, bg = colors[color_name] }
    statusline_groups['StatuslineModeSeparator' .. mode] = { fg = colors[color_name], bg = colors.transparent_black }
end
...
local groups = vim.tbl_extend('error', statusline_groups, {
    -- Builtins.
    Boolean = { fg = colors.purple }, -- Mapped to purple (base0E)
    Character = { fg = colors.green },
    ColorColumn = { bg = colors.selection },
    Comment = { fg = colors.comment, italic = true },
    Conceal = { fg = colors.comment },
    Conditional = { fg = colors.pink },
    Constant = { fg = colors.purple }, -- Mapped to purple (base0E)
    ...
    Function = { fg = colors.green }, -- Mapped to green (base0B)
    Identifier = { fg = colors.cyan },
    IncSearch = { link = 'CurSearch' },
    Include = { fg = colors.purple },
    Keyword = { fg = colors.pink }, -- Mapped to pink
    ...
    BlinkCmpKindColor = { link = 'DevIconCss' }, -- Assuming DevIconCss is defined elsewhere or linked
