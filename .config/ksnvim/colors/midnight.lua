...
vim.g.colors_name = 'deep-ocean-clarity' -- Renamed to reflect the new palette


-- Deep Ocean Clarity Palette Mapping
-- Base16-inspired colors for a comprehensive dark theme.
local colors = {
    -- Core Colors (Shades of Gray/Blue-Gray)
    bg = '#1E2833',             -- base00: Background
    ...
    comment = '#5E6D7E',        -- base03: Subtle UI / Comments
    lilac = '#5E6D7E',          -- base03: Subtle UI, good for line numbers, nontext
    nontext = '#5E6D7E',        -- base03: Subtle UI
    grey = '#8C9DAE',           -- base04: Faded Foreground / Inactive Text
    fg = '#E0E6EB',             -- base05: Default Foreground / Main Text
    white = '#E0E6EB',          -- base05: Same as main foreground
    bright_white = '#FFFFFF',   -- base07: Very Bright / Emphatic UI

    -- Accent Colors (Syntax & Semantic Meanings)
    red = '#D28A7A',            -- base08: Red / Error / Removed
    bright_red = '#D28A7A',     -- base08: Consistent with main red
    orange = '#D9BC8C',         -- base09: Orange / Warning / Numbers
    yellow = '#D9BC8C',         -- base09: Using base09 for main yellow/orange
    bright_yellow = '#D0D978',  -- base0A: Yellow / Other Warnings / Annotations (a slightly different yellow)
    green = '#8ABF93',          -- base0B: Green / Success / Added
    bright_green = '#8ABF93',   -- base0B: Consistent with main green
    cyan = '#71C2CC',           -- base0C: Aqua / Info / Specific Elements
    bright_cyan = '#71C2CC',    -- base0C: Consistent with main cyan
    bright_blue = '#78A3AD',    -- base0D: Blue / Functions / Imports (using base0D for blue)
    purple = '#AB96BE',         -- base0E: Purple / Keywords / Preprocessor
    lavender = '#AB96BE',       -- base0E: Consistent with purple tones
    bright_magenta = '#AB96BE', -- base0E: Consistent with purple tones
    -- Custom vibrant colors for specific uses where a strong pop is desired
    fuchsia = '#E76F97',        -- Custom vibrant pink for strong emphasis
    pink = '#E4A1C1',           -- Custom soft pink
    neon_cyan = '#00E0E0',      -- Custom vibrant cyan for links/special
}
