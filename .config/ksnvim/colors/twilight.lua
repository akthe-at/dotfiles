...
-- My own version of Vibrant Twilight.
...
vim.g.colors_name = 'vibrant-twilight' -- Renamed to reflect the new palette

-- Vibrant Twilight Palette Mapping
-- Base16-inspired colors for a comprehensive dark theme with vibrant accents.
local colors = {
    -- Core Colors (Shades of Dark Blue/Purple-Gray)
    bg = '#1C1D27',             -- base00: Background (very dark, subtle blue/purple undertone)
    black = '#1C1D27',          -- base00: Darkest element, fitting for 'black'
    menu = '#2C2D3A',           -- base01: Lighter Background / Secondary BG (for pop-up menus, etc.)
    transparent_black = '#2C2D3A', -- base01: For overlays like statusline background
    transparent_blue = '#2C2D3A', -- base01: For transparent overlays
    transparent_green = '#2C2D3A', -- base01: For transparent overlays
    transparent_red = '#2C2D3A', -- base01: For transparent overlays
    transparent_yellow = '#2C2D3A', -- base01: For transparent overlays
    selection = '#3D3E4F',      -- base02: Mid-Background / UI Elements / Selection
    visual = '#3D3E4F',         -- base02: Same as selection
    comment = '#7A8498',        -- base03: Subtle UI / Comments (medium-dark, slightly blue-gray)
    lilac = '#7A8498',          -- base03: Subtle UI, good for line numbers, nontext (using base03 for this role)
    nontext = '#7A8498',        -- base03: Subtle UI
    grey = '#AAB4C8',           -- base04: Faded Foreground / Inactive Text (muted light gray-blue)
    fg = '#F3F4F6',             -- base05: Default Foreground / Main Text (crisp, bright off-white)
    white = '#F3F4F6',          -- base05: Same as main foreground
    bright_white = '#FFFFFF',   -- base07: Very Bright / Emphatic UI (pure white)

    -- Accent Colors (Syntax & Semantic Meanings)
    red = '#E76F97',            -- base08: Red / Error / Removed (vibrant pink-red)
    bright_red = '#E76F97',     -- base08: Consistent with main red
    orange = '#EFC985',         -- base09: Orange / Warning / Numbers (clear, warm orange-gold)
    yellow = '#EFC985',         -- base09: Using base09 for main yellow/orange
    bright_yellow = '#F7E68F',  -- base0A: Yellow / Other Warnings / Annotations (clean, bright yellow)
    green = '#8DD193',          -- base0B: Green / Success / Added (fresh, vibrant green)
    bright_green = '#8DD193',   -- base0B: Consistent with main green
    cyan = '#6EBBCA',           -- base0C: Aqua / Info / Specific Elements (clean, light aqua/cyan)
    bright_cyan = '#6EBBCA',    -- base0C: Consistent with main cyan
    bright_blue = '#A37BEF',    -- base0D: Blue / Functions / Imports (bright violet)
    purple = '#D19EEF',         -- base0E: Purple / Keywords / Preprocessor (clear, bright purple)
    lavender = '#D19EEF',       -- base0E: Consistent with purple tones
    bright_magenta = '#D19EEF', -- base0E: Consistent with purple tones
    -- Custom vibrant colors adjusted for the palette's feel
    fuchsia = '#E76F97',        -- Using base08, the vibrant pink-red
    pink = '#E76F97',           -- Using base08, the vibrant pink-red
    neon_cyan = '#6EBBCA',      -- Using base0C, the clean aqua
}
